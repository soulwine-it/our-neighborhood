...
public class EvaluationDTO {
	...
	public void setLectureDivide(String lecturDivide) {
		this.lectureDivide = lecturDivide;
	}
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			...
			String totalScore, String creditScore, String comfortableScore, String scopeScore, int likeCount) {
